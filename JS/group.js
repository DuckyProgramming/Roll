            ...
            case 2:
                ...
                for(let a=0;a<2;a++){
                    ...
                    switch(c){
                        ...
                        break
                        case 3:
                            this.shop.items.push({cost:round(random(1800,2400)),type:10,value:[],sides:types.die.default6,position:{x:300+a*150,y:450}})
                        break
                    }
                }
                for(let a=0;a<2;a++){
                    this.shop.items.push({cost:0,type:0,value:[0],position:{x:600+a*150,y:450}})
                }
